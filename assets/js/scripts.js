function initElcon() {
    ...
    var coninw1 = $(".contact-form-content1"),
        coninbtn1 = $(".contact-form-btn1");
    ...
    function showConInfo1() {
        $(".contact-form-wrap1").fadeIn(100);
        coninw1.addClass("vis-coninfwrap1");
        coninbtn1.removeClass("isconin-btn_vis1");
    }
    function hideConInfo1() {
        coninw1.removeClass("vis-coninfwrap1");
        coninbtn1.addClass("isconin-btn_vis1");
        $(".contact-form-wrap1").fadeOut(100);
    }
    ...
    $(".close-cf1 , .contact-form-overlay1").on("click", function (e) {
        e.preventDefault();
        hideConInfo1();
        $("#message").slideUp(200);
        $(".custom-form").find("input[type=text], textarea").val("");
